        ...
        <div className="px-6 max-w-7xl mx-auto mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <p className="text-sm font-medium text-[#C5A880] tracking-widest uppercase mb-4">
                Salon Profile
              </p>
              ...
              <div className="flex flex-col gap-3 text-[#1A1A1A]/70 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    {salon.rating} out of 5 ({salon.reviews_count} reviews)
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative animate-in zoom-in-95">
              ...
              <p className="text-[#1A1A1A]/60 mb-6">
                ...
                <strong className="text-[#1A1A1A]">{bookingStylist.name}</strong> at {salon.name}.
              </p>
