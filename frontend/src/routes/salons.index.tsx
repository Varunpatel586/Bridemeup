    ...
    <div className="min-h-[100dvh] flex flex-col bg-[#FAFAFA] text-[#1A1A1A] font-sans">
      ...
      <main className="flex-1 pt-5 pb-7 px-6 max-w-7xl mx-auto w-full min-h-[100dvh]">
        <div className="mb-8">
          ...
          <p className="text-[#1A1A1A]/60 max-w-2xl mb-8">
            Discover Delhi's most prestigious salons and freelance artists, curated for your perfect
            day.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 mb-8 bg-white p-4 rounded-xl shadow-sm border border-neutral-100">
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-400" />
              <input
                type="text"
                placeholder="Search by name or location..."
                className="w-full pl-10 pr-4 py-2 bg-neutral-50 border-none rounded-lg focus:ring-2 focus:ring-[#C5A880]/20 outline-none transition-all"
                value={searchQuery}
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                className="bg-neutral-50 py-2 px-4 rounded-lg border-none focus:ring-2 focus:ring-[#C5A880]/20 outline-none text-sm cursor-pointer"
                value={sortBy}
